...
let starkArr=[];
// function starkName(e){
// var first = got.houses.filter(item => e.target.innerText===item.name);
// if(first==="stark"){
//     got.houses.filter(item => e.target.innerText===item.name);
// memberDescribe(first);
// }
// function buttonInput(e){
//     allBtn.addEventListener("click",(item)=>{
